...
const inputVariants = cva(
  'w-full h-[48px] rounded-lg px-3 text-sm transition-all duration-200 placeholder:text-grey-400 dark:placeholder:text-grey-600 dark:text-grey-400 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'border border-[#DEE2E6] bg-white text-grey-900 hover:border-grey-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 dark:bg-[#171B22] dark:text-white dark:border-[#374151] dark:hover:border-grey-600',
        error:
