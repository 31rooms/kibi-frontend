...
export function TabsList({ children, className }: TabsListProps) {
  return (
    <div
      className={cn(
        'inline-flex h-10 items-center justify-center rounded-md bg-gray-100 dark:bg-gray-800 p-1 text-gray-500',
        className
      )}
    >
      {children}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        isActive && 'bg-white dark:bg-gray-700 text-gray-950 dark:text-white shadow-sm',
