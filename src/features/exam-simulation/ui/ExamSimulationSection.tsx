...
import { mockExamQuestions } from '../mocks/questions';
 ...
 * Main section for the exam simulation feature within the dashboard
 * Handles the complete exam flow: questions, summary, and results
 */
export const ExamSimulationSection = React.forwardRef<HTMLElement, React.HTMLAttributes<HTMLElement>>(
  (props, ref) => {
